...
```powershell
spicetify pkg install sakura-lyrics@7.2.1 "https://github.com/JosEffigy/spicy-lyrics-v3/releases/download/v7.2.1/sakura-lyrics@7.2.1.zip"
spicetify pkg enable sakura-lyrics@7.2.1
spicetify apply
```
...
Output: `dist/sakura-lyrics@7.2.1/` and `sakura-lyrics@7.2.1.zip`.
